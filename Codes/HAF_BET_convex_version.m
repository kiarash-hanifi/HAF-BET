...
explain = ['This is the convex version of the HAF-BET Code. ' ...
    'The code only requires the desorption isotherm. ' ...
    'Enter the desorption data as a n×2 array like below:' newline ...
    '[0.06 194' newline ...
    ' 0.12 198' newline ...
    ' 0.5  220' newline ...
    ' 0.97 310]' newline ...
    'Please make sure the desorption isotherm has at least one ' ...
    'pressure ratio below 0.08 and one above 0.965:' newline ...
    ];
des = input(explain);
